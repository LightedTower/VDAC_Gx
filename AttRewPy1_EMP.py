...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/evanpalmer/Library/CloudStorage/GoogleDrive-evan.palmer@sjsu.edu/My Drive/LAVA Lab Resources/Experiments/VDAC_Gx Team/AttRewPy1/AttRewPy1_EMP.py',
...
for thisTrial in trials:
    ...
    # keep track of which components have finished
    trialFeedbackNComponents = [FeedbackText, fixation_large_2, targ_2, dist1_2, dist2_2, dist3_2, dist4_2, dist5_2, FeedbackSound]
    ...
    # set up handler to look after randomisation of conditions etc
    LowRewardLoop = data.TrialHandler(nReps=5.0, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=[None],
    ...
    for thisLowRewardLoop in LowRewardLoop:
        ...
        for thisComponent in trialFeedbackLComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        # the Routine "trialFeedbackL" was not non-slip safe, so reset the non-slip timer
        routineTimer.reset()
        thisExp.nextEntry()
        
    # completed 5.0 repeats of 'LowRewardLoop'
